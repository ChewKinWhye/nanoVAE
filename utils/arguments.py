...
def parse_args():
    ...
    parser.add_argument('--rc_loss_scale', type=float, default=1, help='Scale factor of reconstruction loss')
    parser.add_argument('--feature_scale', type=float, nargs=5, default=(1, 1, 1, 1, 1),
                        help='Scale factor of the features, k-mer, mean, std, len, signals respectively')
    parser.add_argument('--kmer_loss_scale', type=float, default=1, help='Scale factor of kmer_loss')
